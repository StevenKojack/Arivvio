...
export function DemoQuoteJourney({ request, alreadySubmitted = false, onClose, onSubmitted }: {
  ...
  return <dialog ref={dialog} onCancel={onClose} aria-label={submitted ? "Demo request confirmation" : "Review quote request"} className="ui-surface m-auto max-h-[92dvh] w-[min(740px,94vw)] overflow-y-auto rounded-3xl p-5 sm:p-7 backdrop:bg-black/50">
