...
const eventSuggestionLabels: Record<string, string[]> = {
  ...
  "bachelor-party": ["Party bus", "VIP transportation", "Steakhouse", "Nightclub", "Private dining room", "Disc jockey"],
  "bachelorette-party": ["Party bus", "VIP transportation", "Private dining room", "Nightclub", "Photographer", "Disc jockey"],
  ...
  graduation: ["Photo booth", "Photographer", "Taco cart", "Disc jockey", "Balloons"],
  ...
  "sweet-16": ["Teen activities", "Photo booth", "Disc jockey", "Party bus", "Arcade games", "Photographer"],
